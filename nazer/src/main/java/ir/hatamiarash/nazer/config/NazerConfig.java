package ir.hatamiarash.nazer.config;
...
public class NazerConfig implements Serializable {
	...
	private Nazer.EventListener eventListener = null;
	...
	@Nullable
	public Nazer.EventListener getEventListener() {
		return eventListener;
	}
	
	public void setEventListener(@Nullable Nazer.EventListener eventListener) {
		this.eventListener = eventListener;
	}
	
	public static class Builder {
		private NazerConfig config;
		
		@NonNull
		public static Builder create() {
			Builder builder = new Builder();
			NazerConfig currentConfig = Nazer.getConfig();
			
			NazerConfig config = new NazerConfig();
		...
		/**
		 * Defines if Nazer crash interception mechanism is enabled.
		 * Set it to true if you want Nazer to intercept crashes,
		 ...
		 * The default is R.drawable.Nazer_error_image (a cute upside-down bug).
		 */
		@NonNull
		 ...
		 */
		@NonNull
		public Builder eventListener(@Nullable Nazer.EventListener eventListener) {
		...
		@NonNull
		public NazerConfig get() {
			return config;
		}
		
		public void apply() {
			Nazer.setConfig(config);
		}
	}
